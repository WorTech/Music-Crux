...
/**
 * This class creates the Artist DB, using the ObjectMapper to map the JSON objected
 * extracted by the XmlFileReader from the artist.xml (artistXmlFileString) file from Discogs data dump
 */
@Component
@Order(value=1)
