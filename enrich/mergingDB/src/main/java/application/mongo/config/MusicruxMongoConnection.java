...
public class MusicruxMongoConnection extends AbstractMongoConfig {
	 ...
	 *
	 * @Bean gives a name (musiccruxMongoTemplate) to the created MongoTemplate
	 *       instance
	 * @Primary declares that if MongoTemplate is autowired without providing a
	 *          specific name, this is the instance which will be mapped by default
	 */
